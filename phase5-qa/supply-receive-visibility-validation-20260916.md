...
The separate receiver-name display defect is now [repaired and live verified](supply-receipt-actor-display-validation-20260916.md). Its completed synthetic receipt is cleaned, retaining four audit events. Linked stock, partial-receipt accumulation and multi-item atomicity are not claimed verified by this UI permission repair. No camera or provider was used.
