...
def build(output):
    ...
    for name in ('qa_launcher.py', 'qa_transport.py', 'runtime_policy.py', 'api_identity.py', 'qa_access.py', 'qa_offices.py', 'qa_report_export.py', 'qa_execution.py', 'execution_intents.py', 'qa_goal_baselines.py'):
