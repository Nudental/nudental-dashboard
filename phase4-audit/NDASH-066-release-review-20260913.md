...
Production release remains subject to immediate exact-artifact, startup, two/three-year, annual-value and retained-repair checks. Preserve the current release for immediate rollback if a persistent startup or rendering failure appears. Historical blank-screen cause remains a recorded uncertainty; do not claim an authentication repair.
