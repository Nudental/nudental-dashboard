...
Additional verification after039: live Provider Compensation selected Pay Period Aug3–16,2026 with Payday Aug21,2026 and a visible explanation that the Ascend window is one day earlier. AST trace of current production main3aefb73e45d0 confirms Provider Compensation owner rFt passes selectedPeriod.pay_period_start/end unchanged to Sve; other scheduled caller jFt also passes native period dates. The previously tested one-day shift therefore occurs exactly once. Trace evidence: work/phase4-payroll-caller-dates.json. No date logic edited.
