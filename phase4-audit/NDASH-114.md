...
Classification: Section Admin / Sync Dashboard. Severity Medium: functional filters hide matching jobs. Expected filtered rows agree with their state/configuration; actual empty matching lists.
