...
Remaining Overview investigation: merchant/cardholder filters are absent from monthly trend caller and service. Reproduce before editing. Other payroll/Benefits source-authority and department/category filter issues remain unverified; do not retry the earlier rejected employee-data query. No full Overview correctness claim yet.
